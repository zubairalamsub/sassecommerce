...
function AccountContent() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      <h1 className="mb-8 text-2xl font-bold text-text">My Account</h1>
          ...
          {editMode ? (
            ...
            <div className="flex items-start gap-5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="mt-0.5 text-sm text-text-secondary capitalize">{user.role}</p>
                ...
                <div className="mt-5 flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg border border-border px-4 py-2 text-sm font-medium text-text-secondary transition-colors hover:bg-surface-hover"
                  >
          ...
          {showPasswordForm && !editMode && (
            <form onSubmit={handleChangePassword} className="mt-6 space-y-4 border-t border-border pt-6">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg bg-text px-4 py-2 text-sm font-medium text-surface transition-colors hover:bg-text/85 disabled:opacity-60"
              >
        ...
        <div className="rounded-2xl border border-border bg-surface p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-3">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="inline-flex items-center rounded-full bg-green-100 dark:bg-green-900/30 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:text-green-300 capitalize">
                {user.status}
              </span>
            </div>
            <div className="flex items-center justify-between text-sm">
            ...
            {user.last_login_at && (
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-text-secondary">{formatDate(user.last_login_at)}</span>
              </div>
            )}
          </div>
        </div>
