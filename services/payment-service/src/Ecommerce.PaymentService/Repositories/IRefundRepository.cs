...
{
    Task<Refund?> GetByIdAsync(Guid id, string tenantId, CancellationToken cancellationToken = default);
    Task<List<Refund>> GetByPaymentIdAsync(Guid paymentId, string tenantId, CancellationToken cancellationToken = default);
